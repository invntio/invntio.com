...
description: Cuándo son reembolsables los pagos a Invntio, cómo cancelar un proyecto o un plan de hosting y mantenimiento, y cómo solicitar un reembolso.
updated: 2026-09-25
---

Nuestra política es simple: **los pagos no son reembolsables una vez realizados**, salvo en los casos de la sección 5. Solo pedimos un pago después de que aceptas una propuesta escrita que detalla exactamente qué estás pagando.

## Resumen

| Tipo de servicio | Ejemplos | Reembolsos y cancelación |
| --- | --- | --- |
...
- detenemos el trabajo y te entregamos todo lo completado hasta la cancelación, tal como esté;
- conservamos los pagos ya realizados;
- lo que se deba por trabajo ya realizado sigue siendo exigible.

## 2. Planes recurrentes (hosting, mantenimiento, soporte)
...
No reembolsamos los costos pagados a otros proveedores en tu nombre. Entre ellos están registros de dominio, cuentas de desarrollador de Apple y Google, licencias de software, plugins de pago e infraestructura en la nube. Aplica la política de reembolsos de cada proveedor.

## 5. Cuándo sí reembolsamos
...
Si un proyecto pasa 60 días sin respuesta tuya (contenido, accesos, comentarios o aprobaciones), lo damos por cerrado. En ese caso no hay reembolso, y retomarlo requiere una nueva propuesta.

## 7. Cómo cancelar o solicitar un reembolso

Escribe a **{{email}}** desde el correo asociado a tu cuenta e incluye:
