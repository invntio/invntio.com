...
const en = {
    ...
    register: {
        ...
        items: [
            ...
            { name: "Axen", what: "Workout planning app for iOS", url: "https://getaxen.com", domain: "getaxen.com", kind: "own" },
            { name: "Bohío", what: "Condominium management SaaS", url: "https://bohio.app", domain: "bohio.app", kind: "own" },
            {
                name: "Global Merchants Group",
                what: "B2B wholesale catalog and storefront",
    ...
    services: {
        title: "What we build",
        lede: "Five services, each scoped in a written proposal before any work or payment.",
        stackLabel: "Typical stack",
        items: [
            {
                id: "software",
                name: "Custom software development",
                body: "Web applications, internal tools, SaaS products and APIs, built around how your business actually works.",
                stack: "TypeScript · Next.js · Node.js · Quarkus · PostgreSQL",
            },
            {
                id: "mobile",
                name: "Mobile apps",
                body: "Native iOS apps in Swift and SwiftUI, and cross-platform apps in Flutter, from first build to App Store and Google Play release.",
...
const es: Dict = {
    ...
    register: {
        ...
        items: [
            ...
            { name: "Axen", what: "App de planificación de entrenamientos para iOS", url: "https://getaxen.com", domain: "getaxen.com", kind: "own" },
            { name: "Bohío", what: "SaaS de administración de condominios", url: "https://bohio.app", domain: "bohio.app", kind: "own" },
            {
                name: "Global Merchants Group",
                what: "Catálogo y tienda B2B al por mayor",
                url: "https://www.theglobalmerchantsgroup.com/en/default-channel",
                domain: "theglobalmerchantsgroup.com",
                kind: "client",
            },
    ...
    services: {
        ...
        lede: "Cinco servicios, cada uno definido en una propuesta escrita antes de cualquier trabajo o pago.",
        stackLabel: "Tecnologías habituales",
        items: [
            {
                id: "software",
                name: "Desarrollo de software a medida",
                body: "Aplicaciones web, herramientas internas, productos SaaS y APIs, construidos según cómo funciona realmente tu negocio.",
                stack: "TypeScript · Next.js · Node.js · Quarkus · PostgreSQL",
            },
            {
                id: "mobile",
                name: "Apps móviles",
                body: "Apps nativas de iOS en Swift y SwiftUI, y apps multiplataforma en Flutter, desde la primera versión hasta su publicación en App Store y Google Play.",
                stack: "Swift · SwiftUI · Flutter",
            },
            {
                id: "web",
